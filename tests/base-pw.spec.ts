...
test("Borrow book if not log in", async ({ page }) => {
  page.locator("app-new-arrive").getByRole("heading", { name: "Neropatin päiväkirja: Karu" }).click();
  ...
  await expect(page).toHaveURL("https://wonderworld-2a0e3.firebaseapp.com/sign-in");
});
